...
-- Tabela de cobranças (PIX, Crédito, Débito)
CREATE TABLE IF NOT EXISTS cobrancas (
    ...
    CONSTRAINT check_tipo_pagamento CHECK (tipo_pagamento IN ('PIX', 'CREDITO', 'DEBITO'))
);
...
CREATE TABLE IF NOT EXISTS transacoes (
    ...
    dados_webhook JSONB,
    criado_em TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT check_tipo_pagamento_transacoes CHECK (tipo_pagamento IN ('PIX', 'CREDITO', 'DEBITO'))
);
